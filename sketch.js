document.addEventListener('DOMContentLoaded', function(){
    ...
    alternaContraste.addEventListener('click', function(){
        ...
        if (contrasteAtivo) {
            logo.src = 'LogoNoite.png';
            inicioFundo.style.backgroundImage = "linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('foto6.png')"; 
        } else {
            logo.src = 'LogoDia.png';
            inicioFundo.style.backgroundImage = "url('foto6.png')"; 
        }
    });
});
